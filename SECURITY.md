...
3. **Contact directly**: Email details in [CONTRIBUTING.md](CONTRIBUTING.md) for private discussion
...
### **For Contributors**
- **GitHub Security**: [GitHub Security Best Practices](https://docs.github.com/en/code-security)
